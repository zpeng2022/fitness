...
public class H5Controller {
    ...
    public  ResponseEntity<Object> customerChangeBackground(@RequestParam("picture") MultipartFile[] files,HttpServletRequest request){
        String userId = JwtTokenUtil.getUserId(request.getHeader(Constant.ACCESS_TOKEN));
        if(userId==null)
...
//                System.out.println(base64EncoderImg);
        ...
        return new ResponseEntity<>(h5Background, HttpStatus.OK);
    }
