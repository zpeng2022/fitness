...
//        MyPrint.print("pathAddress:"+pathAddress);
        pathAddress= URLDecoder.decode(pathAddress,"UTF-8");
        File file=new File(pathAddress);

        String fileName = file.getName();
        /*String decode= URLDecoder.decode(fileName,"UTF-8");//URLENCODE解码，就不会出现%ER这种字符串了
        fileName=decode;
        MyPrint.print("fileName:"+fileName);*/
...
//            int index=pathAddress.indexOf("%");
//            String s1=pathAddress.substring(0,index);
//            String s2=pathAddress.substring(index);
//            MyPrint.print("pathAddress1："+s1);
//            MyPrint.print("pathAddress2："+s2);
//            s2=URLDecoder.decode(s2,"UTF-8");
//            pathAddress=s1.concat(s2);
//            MyPrint.print("pathAddress："+pathAddress);
